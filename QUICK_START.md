...
4. Choose a transcription model and language.
5. Focus the Windows app where you want text to appear.
6. Press **Ctrl + Shift + F9**, speak, and press it again to transcribe and type.
